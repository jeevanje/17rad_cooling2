...
\begin{figure}[h]
	\begin{center}
			\includegraphics[scale=0.5]{../plots/H1d_rh_gamma_Ts}
...
\begin{figure}[h]
	\begin{center}
			\includegraphics[scale=0.6]{../plots/planck_k1rot}
